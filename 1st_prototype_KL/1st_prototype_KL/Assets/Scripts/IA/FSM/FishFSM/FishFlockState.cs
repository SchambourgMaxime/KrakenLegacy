...
public class FishFlockState : I_State
{
    private static FishFlockState instance = null;
    private static readonly object padlock = new object();

    private FishFlockState() { }

    public static FishFlockState Instance
    {
        get
        {
            lock (padlock)
    ...
    public void Enter(C_BaseGameEntity entity)
    {
        ...
        fish.GetComponentInChildren<BehaviourScript>().setBehaviour("Flock");
    }
